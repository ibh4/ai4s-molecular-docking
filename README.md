...
图 3：从 S35 到 S39 再到 S40_00009 的分子替换路径
图 3：aniline 端分子替换过程
...
图 4：大环与环状 scaffold 遍历样例

图 4 展示了 Stage40 中尝试的三类环状候选：
...
图 5：S40_00009 的 amide anchor 与近邻相互作用
图 5：S40_00009 的 amide anchor 与近邻相互作用

图 5 是 S40_00009 的近距离 interaction 视图。紫色是 ligand，灰色 sticks 是口袋附近残基，黄色虚线表示短距离 polar contact。
